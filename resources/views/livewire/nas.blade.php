<tr class="leading-8 border-b border-cool-gray-400 @if ($state == 1)
    bg-green-200">
    @else
    bg-cool-gray-200">
    @endif     
    ...
    <td>
        <span class="align-middle w-8 h-8" wire:loading>
            <svg class="animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <td class="flex justify-between">
        ...
        <form wire:submit.prevent="switchOff">
            <input type="hidden" wire:model="state">
                <button class="w-8 h-8 align-middle" wire:click="$refresh" type="submit">
